                            ...
                            <div class="w-full h-7 flex justify-between">
                                <div>
                                    ...
                                    @switch($order->status)
                                        ...
                                        @case("delivered")
                                            <button class="text-gray-100 rounded-full bg-[#23b100] uppercase px-1 py-1 text-sm font-bold transition ease-in-out duration-300  hover:scale-110 status-btn" data-id="{{ $order->id }}">{{__($order->status)}}</button>
                                            @break
                    ...
                    if (data.status) {
                        ...
                        switch (data.status) {
                            ...
                            case 'in_delivery':
                                ...
                                break;
                            case 'delivered':
                                button.style.backgroundColor = '#23b100';  // Color para 'delivered'
